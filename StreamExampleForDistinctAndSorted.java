...
public class StreamExampleForDistinctAndSorted {
	...
	public static void main(String[] args) {
		...
		// Descending Order
		List<Integer> descendingOrder = numbers1.stream().sorted(Comparator.reverseOrder())
		...
		// Custom sorting with custom method where odd numbers first and even numbers at
		// the end
		...
		List<Integer> sortedList1 = list1.stream().sorted(reverseComparator1).collect(Collectors.toList());
		...
		List<Integer> sortedList2 = list1.stream().sorted(reverseComparator2).collect(Collectors.toList());
